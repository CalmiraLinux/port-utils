...
* 29.11.2021 Михаил Краснов <linuxoid85@gmail.com>
    * Замена некоторых генераторов на обычные функции.

* 28.11.2021 Михаил Краснов <linuxoid85@gmail.com>
    * Добавление модуля с базовыми функциями API.

* 15.11.2021 Михаил Краснов <linuxoid85@gmail.com>
    * Добавление модуля с функциями для обновления метаданных и системы портов.
    * Смена структуры программы на модульную.

* 25.10.2021 Михаил Краснов <linuxoid85@gmail.com>
    * Обновление Release notes и чистка документации.
    * Добавление функции для определения релиза дистрибутива.
    * Добавление файла с инструкциями по установке порта с помощью port-utils.

* 23.10.2021 Михаил Краснов <linuxoid85@gmail.com>
    * Удаление ненужного обработчика ошибок ввиду его нестабильной работы и высокой вероятности замены файла с описанием ошибок.
    * Удаление функции для проверки и установки обновлений документации дистрибутива.
    * Добавление проверки на приоритет пакета при его удалении.
    * Отключение аргумента командной строки для установки документации CalmiraLinux.
    * Удаление функций для проверки новостей.

* 18.10.2021 Михаил Краснов <linuxoid85@gmail.com>
    * Рефракторинг кода: вынос информации о зависимостях в отдельную функцию.

* 17.10.2021 Михаил Краснов <linuxoid85@gmail.com>
    * Добавление форматированного вывода зависимостей порта.
    * Добавление функции для отображения информации о порте перед его сборкой и установкой.

**Релиз `port-utils v1.0b1`**
